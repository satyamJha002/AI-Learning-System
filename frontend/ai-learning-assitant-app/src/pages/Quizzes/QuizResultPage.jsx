    ...
    <div className="max-w-5xl mx-auto">
        ...
        {detailedResults.map((result, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Explanation */}
              {result.explanation && (
                <div className="p-3 bg-linear-to-br from-slate-50 to-slate-100/50 border border-slate-200 rounded-xl mt-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-xs font-semibold text-slate-600 uppercase transition-wide mb-1">
                        Explanation
                      </p>
      ...
      <div className="mt-8 flex justify-center">
        <Link to={`/documents/${quiz.document._id}`}>
          <button className="groupr relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-emerald-500/25 active:scale-95 overflow-hidden">
